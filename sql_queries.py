...
songplay_table_create = (""" CREATE TABLE IF NOT EXISTS songplay_table (ts timestamp, userId int, level varchar, songid int, artistid int, session_id int, location varchar, userAgent varchar)
""")
